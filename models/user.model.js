...
const userSchema = new Schema({
  ...
  email: {
    ...
    match: [
      EMAIL_PATTERN,
      "Email no válido. Ya tendrás cuenta o lo que sea, pero necesitas proporcionar otro mail",
    ],
  },
  password: {
    type: String,
    required:
      "Necesitas proporcionar un mail. Es por tu seguridad y la nuestra",
    match: [
      PW_PATTERN,
      "Necesitas al menos 5 caracteres. No será muy seguro de todas formas, pero la vida es así...",
    ],
  },
  knowledge: {
    type: String,
